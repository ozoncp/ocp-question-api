...
// Source: github.com/ozoncp/ocp-question-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Question) ([]models.Question, error) {
	m.ctrl.T.Helper()
