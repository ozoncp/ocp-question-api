...
// Source: github.com/ozoncp/ocp-question-api/internal/repo (interfaces: Repo)
...
import (
	...
	models "github.com/ozoncp/ocp-question-api/internal/models"
)
...
func (m *MockRepo) AddEntities(arg0 context.Context, arg1 []models.Question) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) AddEntity(arg0 context.Context, arg1 *models.Question) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 context.Context, arg1 uint64) (*models.Question, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0 context.Context, arg1, arg2 uint64) ([]models.Question, error) {
	m.ctrl.T.Helper()
